...
<!--    </p>-->
<!--    <input id="addfriend" type="submit" value="voeg toe">-->
<!--</div>-->
<main class="d-flex flex-column w-75 m-auto">
    <h1 class="m-auto">${sessionScope.user.name} - ${sessionScope.user.status.name}</h1>

    <h2>change status</h2>
<%--    <select class="w-25" name="status" id="status">--%>
